...
(export '(lambda-parameters-limit call-arguments-limit multiple-values-limit
	  ...
	  char-code-limit identity pi 1+ 1- minusp plusp abs zerop mod rem evenp
	  oddp isqrt conjugate *gensym-counter* gensym first second third fourth
	  fifth sixth seventh eighth ninth tenth rest caar cadr cdar cddr caaar
	  ...
	  cdddar cddddr endp when unless incf decf and or cond return every some
	  ...
	  stringp hash-table-p pathnamep streamp realp numberp equal equalp
