...
make_test ("(gensym)", "#:G8039");
make_test ("(gensym)", "#:G8040");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A8041");
make_test ("(gensym)", "#:G8042");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G8043)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G8043)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G8044)\n(SETQ A #:G8044)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G8045 #:G8046)\n(A B)\n(#:G8047)\n(FUNCALL (FUNCTION (SETF W)) #:G8047 #:G8045 #:G8046)\n(W #:G8045 #:G8046)");
