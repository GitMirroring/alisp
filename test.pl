...
make_test ("(pathname-directory \"\")", "NIL");
...
make_test ("(let ((*print-gensym* nil)) (write (gensym)) (write '#:foo))", "G77FOO\n#:FOO");
...
make_test ("(gensym)", "#:G592");
make_test ("(gensym)", "#:G593");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A594");
make_test ("(gensym)", "#:G595");
