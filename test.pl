...
make_test ("(gensym)", "#:G5996");
make_test ("(gensym)", "#:G5997");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A5998");
make_test ("(gensym)", "#:G5999");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G6000)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G6000)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G6001)\n(SETQ A #:G6001)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G6002 #:G6003)\n(A B)\n(#:G6004)\n(FUNCALL (FUNCTION (SETF W)) #:G6004 #:G6002 #:G6003)\n(W #:G6002 #:G6003)");
