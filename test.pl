...
make_test ("(let ((*print-gensym* nil)) (write (gensym)) (write '#:foo))", "G724FOO\n#:FOO");
...
make_test ("(gensym)", "#:G5235");
make_test ("(gensym)", "#:G5236");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A5237");
make_test ("(gensym)", "#:G5238");
