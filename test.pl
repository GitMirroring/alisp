...
make_test ("(write 1.2 :stream str)", "1.2");
make_test ("(get-output-stream-string str)", "\"AAA\\\"bbb\\\"#\\\\c1001.2\"");
...
make_test ("(cl:package-use-list cl:*package*)", "NIL");
...
make_test ("(car ())", "NIL");
make_test ("(cl:unuse-package 'cl)", "T");
make_test ("(cl:package-use-list cl:*package*)", "NIL");
make_test ("(car ())", "NIL");
