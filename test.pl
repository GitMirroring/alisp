...
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G2)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G2)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G3)\n(SETQ A #:G3)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G4 #:G5)\n(A B)\n(#:G6)\n(FUNCALL (FUNCTION (SETF W)) #:G6 #:G4 #:G5)\n(W #:G4 #:G5)");
...
make_test ("(let ((*print-gensym* nil)) (write (gensym)) (write '#:foo))", "G68FOO\n#:FOO");
...
make_test ("(gensym)", "#:G470");
make_test ("(gensym)", "#:G471");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A472");
make_test ("(gensym)", "#:G473");
