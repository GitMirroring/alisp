...
make_test ("(gensym \"A\")", "#:A523");
make_test ("(gensym)", "#:G524");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G525)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G525)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G526)\n(SETQ A #:G526)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G527 #:G528)\n(A B)\n(#:G529)\n(FUNCALL (FUNCTION (SETF W)) #:G529 #:G527 #:G528)\n(W #:G527 #:G528)");
