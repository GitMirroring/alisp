...
make_test ("(get-setf-expansion '(w a b))", "(#:G2 #:G3)\n(A B)\n(#:G4)\n(FUNCALL (FUNCTION (SETF W)) #:G4 #:G2 #:G3)\n(W #:G2 #:G3)");
...
make_test ("(gensym)", "#:G222");
make_test ("(gensym)", "#:G223");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A224");
make_test ("(gensym)", "#:G225");
