...
make_test ("(gensym)", "#:G143");
make_test ("(gensym)", "#:G144");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A145");
make_test ("(gensym)", "#:G146");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G147)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G147)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G148)\n(SETQ A #:G148)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G149 #:G150)\n(A B)\n(#:G151)\n(FUNCALL (FUNCTION (SETF W)) #:G151 #:G149 #:G150)\n(W #:G149 #:G150)");
