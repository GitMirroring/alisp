...
make_test ("(get-setf-expansion '(w a b))", "(#:G3 #:G4)\n(A B)\n(#:G5)\n(FUNCALL (FUNCTION (SETF W)) #:G5 #:G3 #:G4)\n(W #:G3 #:G4)");
...
make_test ("(let ((*print-gensym* nil)) (write (gensym)) (write '#:foo))", "G421FOO\n#:FOO");
...
make_test ("(gensym)", "#:G3951");
make_test ("(gensym)", "#:G3952");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A3953");
make_test ("(gensym)", "#:G3954");
