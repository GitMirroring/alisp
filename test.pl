...
make_test ("(gensym)", "#:G8052");
make_test ("(gensym)", "#:G8053");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A8054");
make_test ("(gensym)", "#:G8055");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G8056)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G8056)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G8057)\n(SETQ A #:G8057)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G8058 #:G8059)\n(A B)\n(#:G8060)\n(FUNCALL (FUNCTION (SETF W)) #:G8060 #:G8058 #:G8059)\n(W #:G8058 #:G8059)");
