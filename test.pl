...
make_test ("(gensym)", "#:G8032");
make_test ("(gensym)", "#:G8033");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A8034");
make_test ("(gensym)", "#:G8035");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G8036)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G8036)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G8037)\n(SETQ A #:G8037)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G8038 #:G8039)\n(A B)\n(#:G8040)\n(FUNCALL (FUNCTION (SETF W)) #:G8040 #:G8038 #:G8039)\n(W #:G8038 #:G8039)");
