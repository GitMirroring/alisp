...
make_test ("(gensym)", "#:G78");
make_test ("(gensym)", "#:G79");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A80");
make_test ("(gensym)", "#:G81");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G82)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G82)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G83)\n(SETQ A #:G83)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G84 #:G85)\n(A B)\n(#:G86)\n(FUNCALL (FUNCTION (SETF W)) #:G86 #:G84 #:G85)\n(W #:G84 #:G85)");
