...
make_test ("(let nil -)", "(LET NIL -)");
make_test ("+", "(LET NIL -)");
make_test ("(floor 2 1)", "2\n0");
make_test ("/", "(2 0)");
make_test ("*", "(2 0)");
make_test ("***", "2");
make_test ("++", "*");
...
make_test ("(macrolet ((localmac (x y) `(* ,x ,y)) (localmac2 nil '(+))) (macroexpand-1 '(localmac 4 5)))", "(+ 4 5)\nT");
...
make_test ("(setf c 4)", "warning: setting undefined variable C, now it's proclaimed special\n4");
make_test ("c", "4");
make_test ("(setf)", "NIL");
...
make_test ("(let* ((ll '(0 1 2 3 4)) (lll (cddr ll))) (psetf ll nil (cdr ll) '(11 12 13 14)) lll)", "(2 3 4)");
make_test ("(setq)", "NIL");
make_test ("(setq b 9 c 4 c (+ c 1))", "5");
make_test ("(let ((f 0)) (setq g 1) f)", "warning: setting undefined variable G, now it's proclaimed special\n0");
make_test ("(psetq)", "NIL");
make_test ("(psetq xx 0)", "warning: setting undefined variable XX, now it's proclaimed special\nNIL");
make_test ("(psetq xx 1 yy xx)", "warning: setting undefined variable YY, now it's proclaimed special\nNIL");
make_test ("xx", "1");
make_test ("yy", "0");
make_test ("(setf tt (list 'a 'b 'd))", "warning: setting undefined variable TT, now it's proclaimed special\n(A B D)");
...
make_test ("(al:function-name #'car)", "CAR");
make_test ("(al:function-name #'(setf car))", "(SETF CAR)");
make_test ("(al:function-name #'(lambda nil))", "NIL");
make_test ("((lambda (x) (* 2 x)) (*))", "2");
make_test ("(defun f ())", "warning: redefining F globally as a function\nF");
...
make_test ("(defun f (x) \"\")", "warning: redefining F globally as a function\nF");
make_test ("(f 0)", "\"\"");
make_test ("(defun f () (values 1 2))", "warning: redefining F globally as a function\nF");
make_test ("(f)", "1\n2");
make_test ("(defun fun (x y) y)", "FUN");
make_test ("(fun 1 2)", "2");
make_test ("(defun fun (b) b)", "warning: redefining FUN globally as a function\nFUN");
make_test ("(fun 3)", "3");
make_test ("b", "9");
...
make_test ("(defun fun (&rest x) x)", "warning: redefining FUN globally as a function\nFUN");
make_test ("(fun)", "NIL");
make_test ("(defun fun (x &rest y) y)", "warning: redefining FUN globally as a function\nFUN");
make_test ("(fun 5 6 7 8)", "(6 7 8)");
make_test ("(defun fun2 (&rest r &key x y z) y)", "warning: redefining FUN2 globally as a function\nFUN2");
make_test ("(fun2 :y 0)", "0");
make_test ("(fun2 :y 0 :y 1)", "0");
make_test ("(fun2 :x 0)", "NIL");
make_test ("(fun2 :z 'tt :y (+ 1 2))", "3");
make_test ("(fun2)", "NIL");
make_test ("(defun fun2 (&key ((:k aa) 1 supp)) (list aa supp))", "warning: redefining FUN2 globally as a function\nFUN2");
make_test ("(fun2)", "(1 NIL)");
make_test ("(fun2 :k 1)", "(1 T)");
make_test ("(defun fun3 (x &key (y x)) y)", "warning: redefining FUN3 globally as a function\nFUN3");
make_test ("(fun3 10)", "10");
make_test ("(defun fun2 (&rest r &key x y z) r)", "warning: redefining FUN2 globally as a function\nFUN2");
make_test ("(fun2 :y (+ 1 2) :z 'tt)", "(:Y 3 :Z TT)");
make_test ("(fun2)", "NIL");
make_test ("(defun fun (x &rest y &key z) y)", "warning: redefining FUN globally as a function\nFUN");
make_test ("(fun 1 :z 0)", "(:Z 0)");
make_test ("(defun fun (x &optional y &rest z &key k) z)", "warning: redefining FUN globally as a function\nFUN");
make_test ("(fun 0 1 :k 2)", "(:K 2)");
make_test ("(defun f (&key &allow-other-keys))", "warning: redefining F globally as a function\nF");
make_test ("(f :a 0)", "NIL");
make_test ("(defun f (&key x &allow-other-keys) x)", "warning: redefining F globally as a function\nF");
make_test ("(f :x 0 :y 1)", "0");
make_test ("(f)", "NIL");
make_test ("(defun f2 (&key x))", "F2");
make_test ("(f2 :x 0 :allow-other-keys t)", "NIL");
make_test ("(defun f2 (&key x allow-other-keys) allow-other-keys)", "warning: redefining F2 globally as a function\nF2");
make_test ("(f2)", "NIL");
make_test ("(f2 :x 0 :y 0 :allow-other-keys t)", "T");
make_test ("(defun f4 (&key))", "F4");
make_test ("(f4 :a 0 :allow-other-keys t)", "NIL");
make_test ("(defun f (x y &aux (z (+ x y)) w) (list z w))", "warning: redefining F globally as a function\nF");
make_test ("(f 1 2)", "(3 NIL)");
make_test ("(defun f3 (x &key y &aux (z x)) z)", "F3");
make_test ("(f3 0)", "0");
make_test ("(defun f4 (x &aux y (z x)) z)", "warning: redefining F4 globally as a function\nF4");
make_test ("(f4 0)", "0");
...
make_test ("(let ((hh 0)) (defun f nil hh))", "warning: redefining F globally as a function\nF");
make_test ("(f)", "0");
make_test ("(defparameter hh 1)", "HH");
make_test ("(f)", "0");
make_test ("hh", "1");
make_test ("(flet ((foo nil 0)) (defun f10 (x &optional (y (foo))) (list x y)))", "F10");
make_test ("(f10 10)", "(10 0)");
make_test ("(defmacro f () (f))", "warning: redefining F globally as a macro\nF");
make_test ("(defmacro f () (f))", "warning: redefining F globally as a macro\nF");
make_test ("(let ((var 1)) (defmacro mac () var))", "MAC");
make_test ("(mac)", "1");
make_test ("(defparameter foo 0)", "FOO");
make_test ("(defmacro mac () foo)", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(mac)", "0");
#make_test ("(let ((foo 1)) (mac))", "0");
make_test ("(defmacro mac (x (y (z))) `(list ,x ,y ,z))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(mac 0 (1 (2)))", "(0 1 2)");
make_test ("(defmacro mac (()) 0)", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(mac nil)", "0");
make_test ("(defmacro mac (()) 0)", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(defmacro mac (x . z) `(list ,x ,z))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(macroexpand-1 '(mac 0 1 2))", "(LIST 0 (1 2))\nT");
make_test ("(defmacro mac (&rest (x y)) `(list ,x ,y))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(macroexpand-1 '(mac 0 1))", "(LIST 0 1)\nT");
make_test ("(defmacro mac (&rest nil))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(mac)", "NIL");
make_test ("(defmacro mac (&whole wh f g h) `(list ,wh ,f ,g ,h))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(macroexpand-1 '(mac x y z))", "(LIST (MAC X Y Z) X Y Z)\nT");
make_test ("(defmacro mac (z (&whole wh f g)) `(list ,wh ,f ,g))", "warning: redefining MAC globally as a macro\nMAC");
...
make_test ("(gensym)", "#:G558");
make_test ("(gensym)", "#:G559");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A560");
make_test ("(gensym)", "#:G561");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G562)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G562)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G563)\n(SETQ A #:G563)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G564 #:G565)\n(A B)\n(#:G566)\n(FUNCALL (FUNCTION (SETF W)) #:G566 #:G564 #:G565)\n(W #:G564 #:G565)");
...
make_test ("(defmacro mac (&whole wh) wh)", "warning: redefining MAC globally as a macro\nMAC");
...
make_test ("(macrolet ((mac1 nil 0)) (macrolet ((mac1 nil 1)) (macroexpand-with-env (mac1))))", "1\nT");

make_test ("(defparameter x 0)", "X");
make_test ("(defun fun nil (let ((x 1)) x))", "warning: redefining FUN globally as a function\nFUN");
make_test ("(defmacro mac nil (fun))", "warning: redefining MAC globally as a macro\nMAC");
make_test ("(mac)", "1");
...
make_test ("(typep 0 'readtable)", "NIL");
make_test ("(typep (copy-readtable nil) 'readtable)", "T");
...
make_test ("(type-of '`0)", "ALISP:BACKQUOTE");
...
make_test ("(subtypep '(integer 0 1) '(integer 0 1))", "T\nT");
make_test ("(subtypep 'bit '(integer -1 1))", "T\nT");
make_test ("(subtypep '(integer 3) '(integer 4 *))", "NIL\nT");
make_test ("(subtypep '(signed-byte 64) '(unsigned-byte 1))", "NIL\nT");
...
make_test ("(symbol-function 'loop)", "(:MACRO #<FUNCTION ?>)");
make_test ("(symbol-function 'dotimes)", "(:SPECIAL-OPERATOR DOTIMES)");
...
make_test ("(fdefinition 'loop)", "(:MACRO #<FUNCTION ?>)");
make_test ("(fdefinition 'dotimes)", "(:SPECIAL-OPERATOR DOTIMES)");
...
make_test ("(setf (get 's :a) 10)", "10");
make_test ("(setf (get 's :c) 20)", "20");
make_test ("(symbol-plist 's)", "(:C 20 :A 10 :B 1)");
...
make_test ("(symbol-plist 'foo)", "(:D 12 :A 0 :C 11 :B 3)");
make_test ("(let (pl) (setf (getf pl :zero) 0) pl)", "(:ZERO 0)");
...
make_test ("(defun (setf foo4) (x y))", "(SETF FOO4)");
make_test ("(fmakunbound '(setf foo4))", "(SETF FOO4)");
make_test ("(fboundp '(setf foo4))", "NIL");
...
make_test ("(make-array 3 :adjustable t)", "#(NIL NIL NIL)");
...
make_test ("(defparameter arr (make-array 7 :element-type '(unsigned-byte 8)))", "ARR");
make_test ("(setf (elt arr 5) 127)", "127");
make_test ("(setf (aref arr 6) 250)", "250");
make_test ("(elt arr 6)", "250");
make_test ("(aref arr 4)", "0");
make_test ("arr", "#(0 0 0 0 0 127 250)");
make_test ("(defparameter arr (make-array '(2 3) :element-type '(signed-byte 64)))", "ARR");
make_test ("(typep arr 'al:byte-array)", "T");
make_test ("(setf (aref arr 1 2) -10)", "-10");
make_test ("arr", "#2A((0 0 0) (0 0 -10))");
make_test ("(vector)", "#()");
...
make_test ("(parse-integer \" 123456 \" :start 2 :end 5)", "234\n5");
...
make_test ("(setq var 10)", "warning: setting undefined variable VAR, now it's proclaimed special\n10");
...
make_test ("(defun f nil (write 0) (write 1))", "warning: redefining F globally as a function\nF");
make_test ("(f)", "01\n1");
make_test ("(defun f nil (write 0) (values))", "warning: redefining F globally as a function\nF");
make_test ("(f)", "0");
...
make_test ("(defstruct ship \"A ship.\" x y)", "warning: redefining SHIP-X globally as a function\nwarning: redefining (SETF SHIP-X) globally as a function\nwarning: redefining SHIP-Y globally as a function\nwarning: redefining (SETF SHIP-Y) globally as a function\nwarning: redefining MAKE-SHIP globally as a function\nwarning: redefining COPY-SHIP globally as a function\nwarning: redefining SHIP-P globally as a function\nSHIP");
...
make_test ("(defstruct (ship4 (:constructor makeship4) (:constructor make-ship-boa (y z x))) x y z)", "SHIP4");
make_test ("(ship4-x (makeship4 :x 10))", "10");
make_test ("(ship4-x (make-ship-boa 10 11 12))", "12");
make_test ("(defstruct (ship5 (:constructor make-ship5 (y &optional (z 1) &rest x &aux (w z)))) x y z w)", "SHIP5");
make_test ("(let ((str (make-ship5 10))) (list (ship5-x str) (ship5-y str) (ship5-z str) (ship5-w str)))", "(NIL 10 1 1)");
...
make_test ("(block nil (handler-bind ((unbound-slot (lambda (e) (return 10)))) (slot-value inst 'x)))", "10");
...
make_test ("(slot-boundp inst 'x)", "NIL");
make_test ("(block nil (handler-bind ((error (lambda (e) (return 10)))) (slot-boundp inst 'z)))", "10");
...
make_test ("(defclass c34 nil ((x :allocation :class) y u))", "#<STANDARD-CLASS C34>");
make_test ("(defparameter inst (make-instance 'c34))", "INST");
make_test ("(setf (slot-value inst 'x) 10)", "10");
make_test ("(setf (slot-value inst 'y) 11)", "11");
make_test ("(defclass c34 nil ((x :allocation :class :initform 1) (z :initform 20 :allocation :instance) (w :allocation :class :initform 0) (y :initform 12)))", "#<STANDARD-CLASS C34>");
make_test ("(slot-value inst 'x)", "10");
make_test ("(slot-value inst 'y)", "11");
make_test ("(slot-value inst 'w)", "0");
make_test ("(slot-value inst 'z)", "20");
make_test ("(make-instances-obsolete 'c34)", "C34");
make_test ("(slot-value inst 'z)", "20");
make_test ("(defclass c35 nil (x (y :allocation :class)))", "#<STANDARD-CLASS C35>");
make_test ("(defclass c36 (c35) (z))", "#<STANDARD-CLASS C36>");
make_test ("(defparameter inst (make-instance 'c36))", "INST");
make_test ("(setf (slot-value inst 'y) 30)", "30");
make_test ("(defclass c35 nil ((x :allocation :class :initform 40) (y :initform 50)))", "#<STANDARD-CLASS C35>");
make_test ("(slot-value inst 'x)", "40");
make_test ("(defclass c36 nil ((x :reader readx :initform 0) (y :initform 1)))", "#<STANDARD-CLASS C36>");
make_test ("(defclass c37 nil ((y :reader readx :initform 2)))", "#<STANDARD-CLASS C37>");
make_test ("(readx (make-instance 'c36))", "0");
make_test ("(defclass c38 nil ((x :initform 1 :initarg :x :reader c38-x) (y :initform 2 :initarg :y :reader c38-y) (z :initform 3 :initarg :z :reader c38-z)))", "#<STANDARD-CLASS C38>");
make_test ("(let ((inst (make-instance 'c38))) (slot-makunbound inst 'x) (setf (slot-value inst 'z) 4) (shared-initialize inst t :y 11) (list (c38-x inst) (c38-y inst) (c38-z inst)))", "(1 11 4)");
make_test ("(let ((inst (make-instance 'c38))) (slot-makunbound inst 'x) (setf (slot-value inst 'z) 4) (shared-initialize inst '(z) :y 12) (slot-boundp inst 'x))", "NIL");
...
make_test ("(defgeneric genfun (x))", "warning: redefining generic function GENFUN\n#<STANDARD-GENERIC-FUNCTION GENFUN>");
...
make_test ("(ensure-generic-function 'genfun6 :lambda-list '(x))", "#<STANDARD-GENERIC-FUNCTION GENFUN6>");
make_test ("(ensure-generic-function '(setf genfun6) :lambda-list '(x y))", "#<STANDARD-GENERIC-FUNCTION (SETF GENFUN6)>");
...
make_test ("(typep (find-method #'genfun8 nil '(integer)) 'method)", "T");
make_test ("(typep (find-method #'genfun8 nil '(integer)) 'standard-method)", "T");
make_test ("(typep 0 'method)", "NIL");
make_test ("(find-method #'genfun8 '(:after) '(integer))", "#<STANDARD-METHOD GENFUN8 :AFTER (INTEGER)>");
make_test ("(function-lambda-expression (find-method #'genfun8 '(:after) '(integer)))", "((BLOCK GENFUN8 (WRITE 'FIRST)))");
...
make_test ("(defgeneric genfun18 (x))", "#<STANDARD-GENERIC-FUNCTION GENFUN18>");
make_test ("(defmethod genfun18 :around (x) (call-next-method) 20)", "#<STANDARD-METHOD GENFUN18 :AROUND (T)>");
make_test ("(defmethod genfun18 ((x string)) (return-from genfun18 30))", "#<STANDARD-METHOD GENFUN18 (STRING)>");
make_test ("(genfun18 \"\")", "20");
make_test ("(function-lambda-expression #'fle)", "(LAMBDA (B &OPTIONAL C &REST D &KEY E &ALLOW-OTHER-KEYS &AUX F) (BLOCK FLE 0 1 2))\nNIL\nFLE");
...
make_test ("(al:function-body #'compadd)", "((BLOCK COMPADD (+ X 0) 3))");
...
make_test ("(block nil (tagbody (defun f nil (go a)) (go b) a (return 0) b (tagbody a (f))))", "warning: redefining F globally as a function\n0");
...
make_test ("(block nil (defun f nil (return 10)) (block nil (f)) 11)", "warning: redefining F globally as a function\n10");
make_test ("(block a (defun a nil) (block b (defun b nil) (block c (defun c nil))))", "C");
make_test ("(block a (block b (block c (block d (defun f nil (return-from b 10)))) (block e (block b (f))) 11))", "warning: redefining F globally as a function\n10");
make_test ("(defun test () (write 1) (write 2) (return-from test 10) (write 3))", "warning: redefining TEST globally as a function\nTEST");
make_test ("(test)", "12\n10");
make_test ("(defun (setf test3) (x y) (return-from test3 10))", "(SETF TEST3)");
make_test ("(setf (test3 0) 1)", "10");
make_test ("(defun f () (throw 'label (values 0 1 2)))", "warning: redefining F globally as a function\nF");
...
make_test ("(block nil (handler-bind ((division-by-zero (lambda (e) (return 0)))) (handler-bind ((arithmetic-error (lambda (e) (write 1))) (division-by-zero (lambda (e) (write 2)))) (/ 1 0))))", "12\n0");
...
make_test ("(warn \"something bad may happen\")", "warning: something bad may happen\nNIL");
...
make_test ("(map 'vector #'1+ (make-array 3 :element-type '(unsigned-byte 16)))", "#(1 1 1)");
...
make_test ("(remove-if #'evenp '(0 1 2 3 4 5 6) :from-end t :count 2)", "(0 1 2 3 5)");
make_test ("(remove-if #'evenp #(0 1 2 3 4 5 6) :from-end t :count 3)", "#(0 1 3 5)");
make_test ("(remove-if #'evenp '((0) (1) (2) (3) (4) (5) (6)) :from-end t :end 5 :key #'car)", "((1) (3) (5) (6))");
...
make_test ("(list-all-packages)", "(#<PACKAGE \"ALISP\"> #<PACKAGE \"COMMON-LISP-USER\"> #<PACKAGE \"COMMON-LISP\"> #<PACKAGE \"KEYWORD\">)");
make_test ("(make-package \"test\")", "#<PACKAGE \"test\">");
make_test ("(list-all-packages)", "(#<PACKAGE \"test\"> #<PACKAGE \"ALISP\"> #<PACKAGE \"COMMON-LISP-USER\"> #<PACKAGE \"COMMON-LISP\"> #<PACKAGE \"KEYWORD\">)");
...
make_test ("(cl:loop :for s :being :each :symbol :in '|newtest| :do (cl:write s))", "|newtest|SBA\nCOMMON-LISP:NIL");
make_test ("(cl:loop :for s :being :each :symbol :do (cl:write s))", "|newtest|SBA\nCOMMON-LISP:NIL");
...
make_test ("(cl:loop :for s :being :each :present-symbol :in '|newtest| :do (cl:write s))", "|newtest|CLSBA\nNIL");
...
make_test ("(cl:find-all-symbols 'al:exit)", "(ALISP:EXIT)");
...
make_test ("(loop for s being the external-symbols of '|newtest| do (write s) (write 0))", "CDR0JJJ0CDR0\nNIL");
...
make_test ("(defpackage \"aaa\" (:nicknames \"bbb\" |ccc|) (:use cl-user) (:export \"sym\") (:intern \"eee\" \"fff\") (:import-from \"CL\" car caar) (:import-from \"AL\" argc))", "#<PACKAGE \"aaa\">");
...
make_test ("(expt 2 63)", "9223372036854775808");
make_test ("(log 1)", "0.0");
make_test ("(log 2.5)", "0.916290731874155106595");
make_test ("(log 1 0)", "0");
make_test ("(log 2.5 1.2)", "5.02568510266547630039");
make_test ("(log -1)", "#C(0.0 3.141592653589793116)");
make_test ("(asin 0.5)", "0.523598775598298926681");
make_test ("(acos 0.5)", "1.04719755119659740927");
make_test ("(atan 10)", "1.47112767430373470035");
make_test ("(asinh 1)", "0.881373587019542936716");
make_test ("(acosh 1)", "0.0");
make_test ("(atanh 0.5)", "0.549306144334054780032");
...
make_test ("(abs #c(3 4))", "5.0");
make_test ("(phase #c(3 4))", "0.927295218001612187031");
make_test ("(phase 0)", "0.0");
make_test ("(phase -1)", "3.141592653589793116");
make_test ("(zerop -0)", "T");
...
make_test ("(oddp -1)", "T");
make_test ("(integer-length 3)", "2");
make_test ("(integer-length -4)", "2");
make_test ("(logbitp 3 47)", "T");
make_test ("(logbitp 4 -122)", "NIL");
make_test ("(logcount 13)", "3");
make_test ("(logcount -17)", "1");
make_test ("(logcount -24)", "4");
make_test ("(ldb (byte 2 3) 243)", "2");
make_test ("(ldb (byte 0 4) 1000)", "0");
make_test ("(ldb (byte 5 0) -127)", "1");
make_test ("(ldb-test (byte 3 2) 256)", "NIL");
make_test ("(ldb-test (byte 2 1) -13)", "T");
make_test ("(ash 12 3)", "96");
make_test ("(ash 12 0)", "12");
make_test ("(ash 12 -1)", "6");
make_test ("(ash -31 2)", "-124");
make_test ("(ash -43 -4)", "-3");
