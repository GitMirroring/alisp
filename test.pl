...
make_test ("(gensym)", "#:G551");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A552");
make_test ("(gensym)", "#:G553");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G554)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G554)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G555)\n(SETQ A #:G555)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G556 #:G557)\n(A B)\n(#:G558)\n(FUNCALL (FUNCTION (SETF W)) #:G558 #:G556 #:G557)\n(W #:G556 #:G557)");
