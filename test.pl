...
make_test ("(gensym)", "#:G2027");
make_test ("(gensym)", "#:G2028");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A2029");
make_test ("(gensym)", "#:G2030");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G2031)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G2031)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G2032)\n(SETQ A #:G2032)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G2033 #:G2034)\n(A B)\n(#:G2035)\n(FUNCALL (FUNCTION (SETF W)) #:G2035 #:G2033 #:G2034)\n(W #:G2033 #:G2034)");
