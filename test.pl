...
make_test ("(gensym)", "#:G2075");
make_test ("(gensym 5)", "#:G5");
make_test ("(gensym \"A\")", "#:A2076");
make_test ("(gensym)", "#:G2077");
make_test ("(define-setf-expander foo ())", "FOO");
make_test ("(get-setf-expansion '(foo))", "NIL");
make_test ("(get-setf-expansion '(foo2))", "NIL\nNIL\n(#:G2078)\n(FUNCALL (FUNCTION (SETF FOO2)) #:G2078)\n(FOO2)");
make_test ("(get-setf-expansion 'a)", "NIL\nNIL\n(#:G2079)\n(SETQ A #:G2079)\nA");
make_test ("(get-setf-expansion '(w a b))", "(#:G2080 #:G2081)\n(A B)\n(#:G2082)\n(FUNCALL (FUNCTION (SETF W)) #:G2082 #:G2080 #:G2081)\n(W #:G2080 #:G2081)");
