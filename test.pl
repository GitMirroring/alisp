...
make_test ("(defun fun2 (&key a b c) b)", "FUN2");
...
make_test ("(truncate -.1)", "0.e0\n-0.1e0");
make_test ("(round .5)", "0.e0\n0.5e0");
make_test ("(round -1.5)", "-0.2e1\n0.5e0");
make_test ("(= 1)", "T");
make_test ("(= 1 1)", "T");
make_test ("(= 1 2)", "()");
